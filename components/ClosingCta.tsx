    ...
    <section className="bg-mesh-dark text-white py-24 sm:py-32 relative overflow-hidden" id="closing-cta-section">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <p className="text-base sm:text-lg text-white/80 max-w-2xl mx-auto leading-relaxed mb-12">
          Get an instant quote, pick your schedule, and let a vetted cleaner handle the rest —
          with no upfront fees and no obligation.
        </p>
          ...
          >
            <div>
              ...
              <p className="text-xs text-white/80 mt-2 leading-relaxed">
                Answer a few questions about your property and see your quote instantly.
              </p>
            </div>
